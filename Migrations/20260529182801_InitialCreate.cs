    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityPasskeyData", x => x.AttestationObject);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataAttestationObject = table.Column<byte[]>(type: "BLOB", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPasskeys", x => new { x.UserId, x.CredentialId });
                    table.ForeignKey(
                        name: "FK_UserPasskeys_IdentityPasskeyData_DataAttestationObject",
                        column: x => x.DataAttestationObject,
                        principalTable: "IdentityPasskeyData",
                        principalColumn: "AttestationObject",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPasskeys_DataAttestationObject",
                table: "UserPasskeys",
                column: "DataAttestationObject");
        }
